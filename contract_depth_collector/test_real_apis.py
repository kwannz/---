...
from exchanges.mexc_collector_real import MEXCCollectorReal
...
async def test_real_apis():
    ...
    print("=== 测试基于脚本发现的真实API ===\n")
    
    # 测试MEXC
    print("=== 测试MEXC (真实数据版本) ===")
    mexc_collector = MEXCCollectorReal(settings)
    ...
    print("\n=== 测试WEEX (真实数据版本) ===")
    weex_collector = WEEXCollectorReal(settings)
